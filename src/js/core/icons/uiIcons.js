...
export const UI_ICONS = {
    ...
    // Vollbild beenden
    fullscreen_exit: createUiIcon(24, [
        { d: "M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z" }
    ]),

    // Multi-Monitor / Bildschirme
    monitors: createUiIcon(24, [
        { d: "M2 6h8v7H2V6zm-1 9h10v1.5H1V15zm5 1.5h1.5V18H6v-1.5zM14 6h8v7h-8V6zm-1 9h10v1.5H13V15zm5 1.5h1.5V18H18v-1.5z" }
    ]),

    // Pop-Out / Externes Fenster
    popout: createUiIcon(24, [
        { d: "M19 19H5V5h7V3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z" }
    ]),

    // Palette / Linienfarben & Styling
    palette: createUiIcon(24, [
        { d: "M12 3c-4.97 0-9 4.03-9 9 0 2.12.74 4.07 1.97 5.61L4.35 18.5c-.39.39-.39 1.02 0 1.41.39.39 1.02.39 1.41 0l.96-.96C8.25 19.98 10.05 21 12 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-5.5 9c-.83 0-1.5-.67-1.5-1.5S5.67 9 6.5 9 8 9.67 8 10.5 7.33 12 6.5 12zm3-4C8.67 8 8 7.33 8 6.5S8.67 5 9.5 5s1.5.67 1.5 1.5S10.33 8 9.5 8zm5 0c-.83 0-1.5-.67-1.5-1.5S13.67 5 14.5 5s1.5.67 1.5 1.5S15.33 8 14.5 8zm3 4c-.83 0-1.5-.67-1.5-1.5S16.67 9 17.5 9s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z" }
    ]),

    // Bahnhof / Betriebsstelle
    station: createUiIcon(24, [
        { d: "M12 2L2 7v2h2v11h2v-6h12v6h2V9h2V7L12 2zm0 3.5c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5.67-1.5 1.5-1.5zM10 14h4v6h-4v-6z" }
    ]),

    // Uhrzeit / Zeit-Simulation
    clock: createUiIcon(24, [
        { d: "M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm.5-13H11v6l5.2 3.1.8-1.3-4.5-2.7V7z" }
    ]),

    // API / Live-Daten / Netzwerk
    api: createUiIcon(24, [
        { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z" }
    ]),

    // Einstellungen / System
    settings: createUiIcon(24, [
    ...
    // Anzeigetafel / Board
    board: createUiIcon(24, [
        { d: "M20 3H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h6v2H8v2h8v-2h-2v-2h6c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 12H4V5h16v10z" }
    ]),

    // Duplizieren / Kopieren
    copy: createUiIcon(24, [
        { d: "M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z" }
    ]),

    // Bearbeiten / Stift
    edit: createUiIcon(24, [
